...
/**
  ...
  @extends DS.Store
*/
DS.SyncableStore = DS.Store.extend({
  ...
  */
  init: function() {
    var serverConfiguration = this.server,
        clientConfiguration = this.client,
        serverAdapter = serverConfiguration.adapter,
        clientAdapter = clientConfiguration.adapter;

    set(this, 'adapter', serverAdapter);
    set(this, 'clientAdapter', clientAdapter);
  ...
  /**
    ...
    Define an adapter for the client-side storage:

    ```js
    App.myStore = DS.SyncableStore.extend({
      client: {
        adapter: 'App.MyClientAdapter'
      }
    });
    ```
  ...
  */
  ...
  /**
    ...
    Define an adapter for the server-side storage:

    ```js
    App.myStore = DS.SyncableStore.extend({
      server: {
        adapter: 'App.MyServerAdapter'
      }
    });
    ```
  ...
  */
  ...
  /**
    This property returns the client adapter, after resolving a possible
    string key.
    ...
    @returns DS.Adapter
  */
  _clientAdapter: Ember.computed(function() {
    var adapter = get(this, 'clientAdapter');
